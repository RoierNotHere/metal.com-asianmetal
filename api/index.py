...
class handler(BaseHTTPRequestHandler):
    def do_GET(self):
        ...
        try:
            ...
            print("Iniciando petición a ScraperAPI...")
            ...
            if response.status_code == 200:
                ...
                # --- PRINTS PARA CONSOLA DE VERCEL ---
                print(f"VALOR DETECTADO: {precio_valor}")
                print(f"UNIDAD DETECTADA: {unidad_valor}")
                ...
                print(f"Error en ScraperAPI. Código: {response.status_code}")
                resultado = {
                    "error": "Error de ScraperAPI",
                    "codigo": response.status_code,
                    "detalle": response.text[:100] # Imprime solo el inicio del error
                }
